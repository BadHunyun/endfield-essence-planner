...
return { view: "planner" };
      ...
      return {
        ...
        showClearDataModal: state.showClearDataModal,
        showClearDataConfirm: state.showClearDataConfirm,
        clearDataCountdown: state.clearDataCountdown,
        clearDataGroups: state.clearDataGroups,
        clearDataChecked: state.clearDataChecked,
        openClearDataModal: state.openClearDataModal,
        proceedClearDataConfirm: state.proceedClearDataConfirm,
        cancelClearDataConfirm: state.cancelClearDataConfirm,
        executeClearData: state.executeClearData,
        clearDataPresetDefault: state.clearDataPresetDefault,
        clearDataNuclear: state.clearDataNuclear,
        clearDataNuclearKeysOpen: state.clearDataNuclearKeysOpen,
        clearDataPresetAll: state.clearDataPresetAll,
        clearDataAllSelected: state.clearDataAllSelected,
        toggleClearDataGroup: state.toggleClearDataGroup,
        clearDataAnyChecked: state.clearDataAnyChecked,
        clearDataGroupHasData: state.clearDataGroupHasData,
        collectClearDataKeys: state.collectClearDataKeys,
        collectAllLocalStorageKeys: state.collectAllLocalStorageKeys,
        ...
        syncCurrentPlanKey: state.syncCurrentPlanKey,
        syncCurrentPlanLabel: state.syncCurrentPlanLabel,
        syncCurrentPlanExpiresDisplay: state.syncCurrentPlanExpiresDisplay,
        syncCurrentPlanHasExpiry: state.syncCurrentPlanHasExpiry,
